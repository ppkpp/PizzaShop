...
@section('title','Pending_List Page')
                ...
                <div class="col-md-12">
                    ...
                    <div class="table-data__tool">
                        <div class="col-5 table-data__tool-left">
                            <div class="overview-wrap">
                                <h2 class="title-1">Pending Orders List</h2>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex">
                        <div class="col-1 pt-2 shadow-sm text-center">
                            <i class="fas fa-database"></i> - {{$pendingCount}}
                        </div>
...
@section('scriptSource')
    <script>
        ...
        //         $.ajax({
        //             type :'get',
        //             url : 'http://127.0.0.1:8000/admin/ajax/order/list',
        //             data : {
        //                 'status' : $status,
        //             },
        //             dateType : 'json',
        ...
        //                         <td>${response[$i].created_at->format('d/m/Y')}</td>
        ...
        //                                 <option value="1" ${response[$i].status}>Accepted</option>
        //                                 <option value="2" ${response[$i].status}>Rejected</option>
        //                             </select>
        //                         </td>
        //                     </tr>
        //                     `;

    ...
    <div class="main-content">
        <div class="section__content section__content--p30">
            <div class="container-fluid">
                <div class="col-md-12">
                    <div class="">
                        <a href="{{route('order#list#admin')}}"><button class="btn my-3 btn-dark text-white"><i class="fas fa-backward"></i> Back</button></a>
                    </div>
                    <!-- DATA TABLE -->
                                ...
                                @foreach ($orderList as $o)
                                    <tr class="tr-shadow text-center">
                                        <div class="row">
                                            ...
                                            <td class="col-2" >{{$o->product_name}} Kyats</td>
                                            <td class="col-2">{{$o->quantity}}</td>
                                            <td class="col-2">{{$o->product_price * $o->quantity}}</td>
                                        </div>
                                    </tr>
                                @endforeach
                            </tbody>
